...
if __name__ == '__main__':
    ...
    ##############################################################################################################################################################################################
    #2.1 PoI Selection
    poi_xors = poi_selection_options(dataset, nb_poi, total_samplept, number_of_traces, X_profiling, L_profiling, image_root,poi_root, poi_selection_mode, plot_cpa_image=False, save_poi=False)
    ...
    for i in range(9):
        for j in range(9):
            text = ax.text(j, i, np.round(noise_transition_matrix_m[i, j],decimals=2), ha="center", va="center", color="w")
    ...
    for i in range(9):
        for j in range(9):
            text = ax.text(j, i, np.round(noise_transition_matrix_y[i, j],decimals=2), ha="center", va="center", color="w")
